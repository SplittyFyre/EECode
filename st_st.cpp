...
int main(void) {
    ...
    sparsetable<int, std::greater<int>> stmax(N, a);
    sparsetable<int, std::less<int>> stmin(N, a);

    int l = 1, r = 1;
    while (r <= N) {
        while (stmax.query(l, r) - stmin.query(l, r) > K) {
            f[l] = {l, r - 1};
            l++;
        }
        g[r] = {l, r};
    ...
    sparsetable<subarray, compareSubarrays> st(N, f);
